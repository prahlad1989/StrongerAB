...
influencer_mandatory_fields =['Country','Influencer/Prospect','Date','Manager']
is_influencer_choices = ["", "Prospect", "Influencer",'PR_','Affiliate']
...
centra_api_revenue_click_start = "2021-03-01"